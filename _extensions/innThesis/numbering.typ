...
// innThesis: theorem-render is overridden below in typst-template.typ where the
// INN palette is available; this definition only has to exist before Quarto's
// definitions.typ is emitted.
